...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('semantic_blog_enhancement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=20000)),
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['semantic_blog.Entity'])),
        ))
        ...
        db.create_table('semantic_blog_article_enhancements', (
            ...
            ('enhancement', models.ForeignKey(orm['semantic_blog.enhancement'], null=False))
        ))
        db.create_unique('semantic_blog_article_enhancements', ['article_id', 'enhancement_id'])
    ...
    def backwards(self, orm):
        ...
        db.add_column('semantic_blog_article', 'meta',
                      self.gf('django.db.models.fields.CharField')(max_length=20000, null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'semantic_blog.enhancement': {
            ...
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['semantic_blog.Entity']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
