...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('semantic_blog_article', (
            ...
            ('content', self.gf('django.db.models.fields.CharField')(max_length=20000)),
        ))
        ...
        db.create_table('semantic_blog_userarticleconnection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['semantic_blog.UserProfile'])),
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['semantic_blog.Article'])),
