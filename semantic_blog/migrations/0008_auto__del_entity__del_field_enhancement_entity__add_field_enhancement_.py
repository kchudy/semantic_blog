...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('semantic_blog_article_tags', (
            ...
            ('article', models.ForeignKey(orm['semantic_blog.article'], null=False)),
            ('tag', models.ForeignKey(orm['semantic_blog.tag'], null=False))
        ))
        db.create_unique('semantic_blog_article_tags', ['article_id', 'tag_id'])

        # Deleting field 'Enhancement.entity'
        db.delete_column('semantic_blog_enhancement', 'entity_id')

        # Adding field 'Enhancement.comment'
        db.add_column('semantic_blog_enhancement', 'comment', self.gf('django.db.models.fields.CharField')(max_length=20000, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('semantic_blog_entity', (
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=20000)),
        ...
        db.create_table('semantic_blog_entity_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('entity', models.ForeignKey(orm['semantic_blog.entity'], null=False)),
            ('tag', models.ForeignKey(orm['semantic_blog.tag'], null=False))
        ))
        ...
        db.add_column('semantic_blog_enhancement', 'entity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['semantic_blog.Entity'], null=True), keep_default=False)
    ...
    models = {
        ...
        'semantic_blog.article': {
            ...
            'content': ('django.db.models.fields.CharField', [], {'max_length': '20000'}),
            'enhancements': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['semantic_blog.Enhancement']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['semantic_blog.Tag']", 'symmetrical': 'False'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        'semantic_blog.enhancement': {
            'Meta': {'object_name': 'Enhancement'},
            'comment': ('django.db.models.fields.CharField', [], {'max_length': '20000', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'value': ('django.db.models.fields.CharField', [], {'max_length': '20000'})
        },
        'semantic_blog.tag': {
        ...
        'semantic_blog.userarticleconnection': {
            ...
            'article': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['semantic_blog.Article']"}),
            'connection': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['semantic_blog.UserProfile']"})
        },
